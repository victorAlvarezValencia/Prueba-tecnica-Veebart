...
def buscar_palabras(sopa_de_letras, palabras_a_buscar):
    ...
    # Ordenar la lista de palabras encontradas por orden alfabetico
    palabras_encontradas.sort()
    # Ordenar la lista de palabras no encontradas por orden alfabetico
    palabras_noEncontradas.sort()
